...
<div class="container">
    <div class="card">
        ...
        <h1>PHP Test Site</h1>
        <p class="subtitle">
            Your PHP website is running successfully!
        </p>
        ...
        <div class="info">
            ...
            <div>
                ...
                <strong><?= htmlspecialchars($serverTime) ?></strong>
            </div>
        </div>
